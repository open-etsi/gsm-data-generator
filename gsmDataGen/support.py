...
import gsmDataGen
# import gsmDataGen.ffi
# from .runtime.module import Module
# from . import get_global_func

# gsmDataGen.ffi._init_api("support", __name__)
...
# def describe():
#     """
#     Print out information about DATAGEN and the current Python environment
#     """
...
#     lines = [
#         f"DATAGEN version    = {gsmDataGen.__version__}",

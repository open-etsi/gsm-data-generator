...
#     #   $PREFIX/lib/python3.6/site-packages/datagen/_ffi
...
#             lib_dll_names = ["libdatagen.dll", "datagen.dll"]
...
#             for p in dll_path
#             if not p.endswith("python/datagen")
#         ]
#         runtime_dll_path = [
#             os.path.join(p, name)
...
# The following line is set by datagen/python/update_version.py

...
def _bind_generic_ops():
    ...
    __op_priority__ = 1
    if __op_priority__ > gsmDataGen.tir.generic.__op_priority__:
        gsmDataGen.tir.generic.__op_priority__ = __op_priority__
        gsmDataGen.tir.generic.add = _make_bop(_broadcast.add, gsmDataGen.tir.generic.add)
        gsmDataGen.tir.generic.subtract = _make_bop(_broadcast.subtract, gsmDataGen.tir.generic.subtract)
        gsmDataGen.tir.generic.multiply = _make_bop(_broadcast.multiply, gsmDataGen.tir.generic.multiply)
        gsmDataGen.tir.generic.divide = _make_bop(_broadcast.divide, gsmDataGen.tir.generic.divide)
        gsmDataGen.tir.generic.cast = _math.cast

...
from gsm_data_generator.tir import IterVar, PrimExpr, Var
from gsm_data_generator.tir.analysis import undefined_vars
from gsm_data_generator.tir.schedule.schedule import BlockRV
...
class MetalMatmul(GPUScheduleRule):
    ...
    def apply(  # pylint: disable=too-many-locals,missing-docstring
        ...
        from gsm_data_generator.tir.tensor_intrin.metal import (  # pylint: disable=import-outside-toplevel
...
class MatmulTensorization(GPUScheduleRule):
    ...
    def apply(  # pylint: disable=too-many-locals,missing-docstring
        ...
        from gsm_data_generator.tir.tensor_intrin.cuda import (  # pylint: disable=import-outside-toplevel

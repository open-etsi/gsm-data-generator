...
from gsm_data_generator.tir import Block, BufferStore
from gsm_data_generator.tir.expr import BufferLoad, Call, Cast
...
def identify_rsqrt_block(block: Block) -> bool:
    ...
    return op == gsm_data_generator.ir.op.Op.get("tir.rsqrt")

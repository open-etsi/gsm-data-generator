...
def from_dlpack(ext_tensor):
    ...
    """
    return gsm_data_generator.ffi.from_dlpack(
        ext_tensor,
...
@gsm_data_generator.ffi.register_object("ffi.NDArray")
class NDArray(gsm_data_generator.ffi.core.NDArray):
    ...
    def copyfrom(self, source_array):
        ...
        t = gsm_data_generator.ffi.dtype(self.dtype)
        ...
        numpy_str_map = gsm_data_generator.ffi.dtype.NUMPY_DTYPE_TO_STR
        np_dtype_str = (
    ...
    def copyto(self, target, mem_scope=None):
        ...
        if isinstance(target, gsm_data_generator.ffi.core.Device):
    ...
    def _create_view(self, shape, dtype: Optional[str] = None, relative_byte_offset: int = 0):
        ...
        if not isinstance(shape, gsm_data_generator.runtime.ShapeTuple):
            shape = gsm_data_generator.runtime.ShapeTuple([int(dim) for dim in shape])
...
gsm_data_generator.ffi.core._set_class_ndarray(NDArray)

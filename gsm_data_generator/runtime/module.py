...
from gsm_data_generator.base import _RUNTIME_ONLY
...
@gsm_data_generator.ffi.register_object("runtime.Module")
class Module(gsm_data_generator.ffi.Object):
    """Runtime Module."""
    ...
    def export_library(
        ...
        **kwargs,
        ...
        from gsm_data_generator.contrib import cc as _cc, tar as _tar, utils as _utils, tvmjs as _tvmjs
...
def load_module(path, fmt=""):
    ...
    if path.endswith(".o"):
        ...
        # Extra dependencies during runtime.
        from gsm_data_generator.contrib import cc as _cc, utils as _utils, tar as _tar

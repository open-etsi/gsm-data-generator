...
@gsm_data_generator.ffi.register_object("transform.PassInfo")
class PassInfo(gsm_data_generator.runtime.Object):
...
@gsm_data_generator.ffi.register_object("transform.PassContext")
class PassContext(gsm_data_generator.runtime.Object):
...
@gsm_data_generator.ffi.register_object("transform.Pass")
class Pass(gsm_data_generator.runtime.Object):
...
@gsm_data_generator.ffi.register_object("transform.ModulePass")
...
@gsm_data_generator.ffi.register_object("transform.Sequential")

...
@gsm_data_generator.ffi.register_object("instrument.PassInstrument")
class PassInstrument(gsm_data_generator.runtime.Object):
...
@gsm_data_generator.ffi.register_object("instrument.PassInstrument")
class PassTimingInstrument(gsm_data_generator.runtime.Object):

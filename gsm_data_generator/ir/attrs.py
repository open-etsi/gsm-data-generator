...
import gsm_data_generator.runtime._ffi_node_api
from . import _ffi_api


@gsm_data_generator.ffi.register_object("ir.Attrs")
class Attrs(Object):
...
@gsm_data_generator.ffi.register_object("ir.DictAttrs")
...
def make_node(type_key, **kwargs):
    ...
    **kwargs : dict
    ...
    for k, v in kwargs.items():
        args += [k, v]
    return gsm_data_generator.runtime._ffi_node_api.MakeNode(*args)

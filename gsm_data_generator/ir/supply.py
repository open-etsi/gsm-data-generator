...
from gsm_data_generator import Object, IRModule
from . import _ffi_api


@gsm_data_generator.ffi.register_object("ir.NameSupply")
...
@gsm_data_generator.ffi.register_object("ir.GlobalVarSupply")
class GlobalVarSupply(Object):
    ...
    def __init__(self, value=None):
        ...
        elif isinstance(value, (list, gsm_data_generator.container.Array)):

...
@gsm_data_generator.register_func("diagnostics.override_renderer")
...
@gsm_data_generator.ffi.register_object("Diagnostic")
...
@gsm_data_generator.ffi.register_object("DiagnosticRenderer")
...
@gsm_data_generator.ffi.register_object("DiagnosticContext")

...
from gsm_data_generator.ffi import get_global_func, register_object
from gsm_data_generator.runtime import Object, _ffi_node_api
...
def structural_equal(lhs, rhs, map_free_vars=False):
    ...
    """
    lhs = gsm_data_generator.runtime.convert(lhs)
    rhs = gsm_data_generator.runtime.convert(rhs)

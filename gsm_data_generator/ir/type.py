...
from gsm_data_generator.runtime import Scriptable

from . import _ffi_api
from .base import Node


@gsm_data_generator.ffi.register_object("ir.Type")
class Type(Node, Scriptable):
    """The base class of all types."""

    def __eq__(self, other):
        """Compare two types for structural equivalence."""
        return bool(gsm_data_generator.ir.structural_equal(self, other))
...
@gsm_data_generator.ffi.register_object("ir.PrimType")
class PrimType(Type):
...
@gsm_data_generator.ffi.register_object("ir.PointerType")
...
@gsm_data_generator.ffi.register_object("ir.TupleType")
...
@gsm_data_generator.ffi.register_object("ir.FuncType")
class FuncType(Type):
    """Function type.
...
@gsm_data_generator.ffi.register_object("ir.TensorMapType")

...
#                 if isinstance(tensor.op, gsm_data_generator.te.ComputeOp):
#                     _traverse(tensor.op)
#         callback(op)
...
#     """
#     if not x:
#         return gsm_data_generator.tir.const(1, "int32")
#     res = x[0]
...
#         return expr
#     if not isinstance(expr, gsm_data_generator.tir.IntImm):
...
#         return float(expr)
#     if not isinstance(expr, gsm_data_generator.tir.FloatImm):
#         ana = gsm_data_generator.arith.Analyzer()
#         expr = ana.simplify(expr)
#     if not isinstance(expr, gsm_data_generator.tir.FloatImm):
...
#         if isinstance(elem, gsm_data_generator.tir.Var):
#             ret.append(elem)
#         elif not isinstance(elem, (gsm_data_generator.tir.IntImm, int)):
#             ana = gsm_data_generator.arith.Analyzer() if ana is None else ana
#             elem = ana.simplify(elem)
#             if not isinstance(elem, gsm_data_generator.tir.IntImm):
#                 ret.append(elem)
#             else:
...
#             tag="simplify",
#         )
#     elif isinstance(expr, gsm_data_generator.tir.PrimExpr):
#         return gsm_data_generator.arith.Analyzer().simplify(expr)
#     else:
#         return expr
...
#             for jj in range(col):
#                 now = gsm_data_generator.tir.Select(
#                     gsm_data_generator.tir.all(idxm(i, row) == ii, idxm(j, col) == jj),
#                     gsm_data_generator.tir.const(matrix[ii][jj], dtype),
#                     now,
#                 )
#         return now
...
#     return gsm_data_generator.tir.indexdiv(a + (b - 1), b)
...
#     target = gsm_data_generator.target.Target.current(allow_none=False)

...
from gsm_data_generator.topi.nn.utils import get_pad_tuple3d
...
def _conv3d_transpose_ncdhw_python(a_np, w_np, stride, padding, output_padding):
    ...
    # dilate stage
    dilated_a_np = gsm_data_generator.topi.testing.dilate_python(a_np, [1, 1, stride_d, stride_h, stride_w])
    ...
    b_np = gsm_data_generator.topi.testing.conv3d_ncdhw_python(

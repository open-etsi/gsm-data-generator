...
def _bind_generic_ops():
    ...
    __op_priority__ = 1
    if __op_priority__ > gsm_data_generator.tir.generic.__op_priority__:
        gsm_data_generator.tir.generic.__op_priority__ = __op_priority__
        gsm_data_generator.tir.generic.add = _make_bop(_broadcast.add, gsm_data_generator.tir.generic.add)
        gsm_data_generator.tir.generic.subtract = _make_bop(_broadcast.subtract, gsm_data_generator.tir.generic.subtract)
        gsm_data_generator.tir.generic.multiply = _make_bop(_broadcast.multiply, gsm_data_generator.tir.generic.multiply)
        gsm_data_generator.tir.generic.divide = _make_bop(_broadcast.divide, gsm_data_generator.tir.generic.divide)
        gsm_data_generator.tir.generic.cast = _math.cast

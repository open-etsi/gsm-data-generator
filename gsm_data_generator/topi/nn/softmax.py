...
@gsm_data_generator.te.tag_scope(tag="softmax_output")
...
@gsm_data_generator.te.tag_scope(tag="fast_softmax_output")
...
def softmax_common(x, axis, use_fast_exp):
    ...
    def _compute_max(*indices):
        ...
        return gsm_data_generator.te.max(x[eval_range], axis=k1)
...
@gsm_data_generator.te.tag_scope(tag="log_softmax_output")

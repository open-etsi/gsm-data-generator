...
if TYPE_CHECKING:
    ...
    from gsm_data_generator.meta_schedule.runner import EvaluatorConfig, RPCConfig
    from gsm_data_generator.runtime import Device, Module, NDArray
...
def _args_to_device(args, device):
    ...
    from gsm_data_generator.runtime.ndarray import NDArray, empty
...
def _normalize_export_func(export_func, output_format) -> Tuple[Callable, str]:
    from gsm_data_generator.contrib import ndk, tar
...
def local_run(  # pylint: disable=too-many-arguments,too-many-locals
    ...
    from gsm_data_generator.runtime import device, load_module

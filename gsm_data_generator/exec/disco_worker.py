...
from gsm_data_generator.runtime import NDArray, ShapeTuple, String
...
def _make_callback(device: gsm_data_generator.runtime.Device) -> Callable[[str, int], NDArray]:
    ...
    def fget_item(param_name: str, param_index: int) -> NDArray:
        ...
        return gsm_data_generator.nd.array(arr, device=device)

...
import gsm_data_generator.ir._ffi_api
from gsm_data_generator import ir
from gsm_data_generator.ir import Op, PrimExpr
from gsm_data_generator.ir.base import Span
from gsm_data_generator.runtime import Object, ObjectGeneric, Scriptable, DataType, DataTypeCode, const
...
@gsm_data_generator.ffi.register_object("tir.Var")
...
@gsm_data_generator.ffi.register_object("tir.SizeVar")
class SizeVar(Var):
...
@gsm_data_generator.ffi.register_object("tir.IterVar")
    ...
    def __init__(
        ...
        if dom is not None:
            if isinstance(dom, (list, tuple)):
                ...
                dom = gsm_data_generator.ir.Range(dom[0], dom[1])

            if not isinstance(dom, gsm_data_generator.ir.Range):
...
@gsm_data_generator.ffi.register_object("tir.CommReducer")
...
@gsm_data_generator.ffi.register_object("tir.Reduce")
...
@gsm_data_generator.ffi.register_object("ir.FloatImm")
class FloatImm(ConstExpr):
    ...
    def __init__(self, dtype: str, value: float, span: Optional[Span] = None) -> None:
        self.__init_handle_by_constructor__(
            gsm_data_generator.ir._ffi_api.FloatImm, dtype, value, span  # type: ignore
        )
...
@gsm_data_generator.ffi.register_object("ir.IntImm")
class IntImm(ConstExpr):
    ...
    def __init__(self, dtype: str, value: int, span: Optional[Span] = None) -> None:
        self.__init_handle_by_constructor__(
            gsm_data_generator.ir._ffi_api.IntImm, dtype, value, span  # type: ignore
        )
...
@gsm_data_generator.ffi.register_object("tir.StringImm")  # type: ignore
...
@gsm_data_generator.ffi.register_object("tir.Cast")
...
@gsm_data_generator.ffi.register_object("tir.Add")
...
@gsm_data_generator.ffi.register_object("tir.Sub")
...
@gsm_data_generator.ffi.register_object("tir.Mul")
...
@gsm_data_generator.ffi.register_object("tir.Div")
...
@gsm_data_generator.ffi.register_object("tir.Mod")
...
@gsm_data_generator.ffi.register_object("tir.FloorDiv")
...
@gsm_data_generator.ffi.register_object("tir.FloorMod")
...
@gsm_data_generator.ffi.register_object("tir.Min")
...
@gsm_data_generator.ffi.register_object("tir.Max")
...
@gsm_data_generator.ffi.register_object("tir.EQ")
class EQ(CmpExpr):
    """EQ node.
...
@gsm_data_generator.ffi.register_object("tir.NE")
class NE(CmpExpr):
    """NE node.
...
@gsm_data_generator.ffi.register_object("tir.LT")
class LT(CmpExpr):
    """LT node.
...
@gsm_data_generator.ffi.register_object("tir.LE")
class LE(CmpExpr):
    """LE node.
...
@gsm_data_generator.ffi.register_object("tir.GT")
class GT(CmpExpr):
    """GT node.
...
@gsm_data_generator.ffi.register_object("tir.GE")
class GE(CmpExpr):
    """GE node.
...
@gsm_data_generator.ffi.register_object("tir.And")
...
@gsm_data_generator.ffi.register_object("tir.Or")
...
@gsm_data_generator.ffi.register_object("tir.Not")
...
@gsm_data_generator.ffi.register_object("tir.Select")
...
@gsm_data_generator.ffi.register_object("tir.BufferLoad")
...
@gsm_data_generator.ffi.register_object("tir.ProducerLoad")
...
@gsm_data_generator.ffi.register_object("tir.Ramp")
...
@gsm_data_generator.ffi.register_object("tir.Broadcast")
...
@gsm_data_generator.ffi.register_object("tir.Shuffle")
...
@gsm_data_generator.ffi.register_object("tir.Call")
...
@gsm_data_generator.ffi.register_object("tir.Let")

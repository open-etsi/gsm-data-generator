...
from gsm_data_generator.ir import PrimExpr, Range, Span
from gsm_data_generator.runtime import Object, Scriptable, const, NDArray
...
@gsm_data_generator.ffi.register_object("tir.LetStmt")
class LetStmt(Stmt):
    """LetStmt node.
...
@gsm_data_generator.ffi.register_object("tir.AssertStmt")
...
@gsm_data_generator.ffi.register_object("tir.For")
class For(Stmt):
    """For node.
...
@gsm_data_generator.ffi.register_object("tir.While")
class While(Stmt):
    """While node.
...
@gsm_data_generator.ffi.register_object("tir.BufferStore")
...
@gsm_data_generator.ffi.register_object("tir.BufferRealize")
...
@gsm_data_generator.ffi.register_object("tir.Allocate")
class Allocate(Stmt):
    """Allocate node.
...
@gsm_data_generator.ffi.register_object("tir.AllocateConst")
...
@gsm_data_generator.ffi.register_object("tir.DeclBuffer")
...
@gsm_data_generator.ffi.register_object("tir.AttrStmt")
class AttrStmt(Stmt):
    """AttrStmt node.
...
@gsm_data_generator.ffi.register_object("tir.SeqStmt")
class SeqStmt(Stmt):
...
@gsm_data_generator.ffi.register_object("tir.IfThenElse")
...
@gsm_data_generator.ffi.register_object("tir.Evaluate")
class Evaluate(Stmt):
    """Evaluate node.
...
@gsm_data_generator.ffi.register_object("tir.BufferRegion")
...
@gsm_data_generator.ffi.register_object("tir.MatchBufferRegion")
...
@gsm_data_generator.ffi.register_object("tir.Block")
class Block(Stmt):
    """Block node.
...
@gsm_data_generator.ffi.register_object("tir.BlockRealize")

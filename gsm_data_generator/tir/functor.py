...
from gsm_data_generator.runtime.support import derived_object
...
@gsm_data_generator.ffi.register_object("tir.PyStmtExprVisitor")
...
@gsm_data_generator.ffi.register_object("tir.PyStmtExprMutator")

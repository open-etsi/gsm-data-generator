...
def default_tir_pipeline():
    ...
    def _pipeline(mod: gsm_data_generator.ir.IRModule, _ctx: gsm_data_generator.transform.PassContext) -> gsm_data_generator.ir.IRModule:
        ...
        pass_ctx = gsm_data_generator.transform.PassContext.current()
        ...
        mod = gsm_data_generator.ir.transform.Sequential(passes)(mod)
        return mod
...
def finalize_host_passes():  # pylint: disable=unused-argument
    ...
    return gsm_data_generator.ir.transform.Sequential(host_pass_list)
...
def finalize_device_passes():  # pylint: disable=unused-argument
    ...
    return gsm_data_generator.ir.transform.Sequential(device_pass_list)
...
def get_tir_pipeline(name: str = "default", **kwargs) -> gsm_data_generator.transform.Pass:
...
def get_default_tir_pipeline(
    target: gsm_data_generator.target.Target,  # pylint: disable=unused-argument
) -> gsm_data_generator.transform.Pass:

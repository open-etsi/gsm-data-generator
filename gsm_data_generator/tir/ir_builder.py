...
from gsm_data_generator.runtime import ObjectGeneric, const
from gsm_data_generator.ir import container as _container
...
class BufferVar(ObjectGeneric):
    ...
    def _normalize_index(self, index):
        ...
        if len(index) == 1 and len(self._buffer.shape) != 1:
            index = gsm_data_generator.topi.utils.unravel_index(index[0], self._buffer.shape)
    ...
    def __setitem__(self, index, value):
        ...
        if isinstance(value, (int, bool, float)):
            value = gsm_data_generator.tir.const(value)

...
from gsm_data_generator.tir.expr import Var
from gsm_data_generator.tir.stmt import Block, BufferRegion, PrimExpr
...
def get_vtcm_compaction_passes() -> List[gsm_data_generator.transform.Pass]:

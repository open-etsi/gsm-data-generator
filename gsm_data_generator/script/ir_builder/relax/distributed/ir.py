...
from gsm_data_generator.ir import PrimExpr
from gsm_data_generator.relax.expr import Expr, ShapeExpr, Call, ExternFunc, Constant
from gsm_data_generator.relax.expr import Tuple as RxTuple
from gsm_data_generator.relax.distributed import DTensorStructInfo
from gsm_data_generator.relax.utils import args_converter
from gsm_data_generator import base as _base
from gsm_data_generator.runtime import ndarray as _nd
from gsm_data_generator.relax.op.distributed import (
    redistribute as _redistribute,
    annotate_sharding as _annotate_sharding,
    call_tir_local_view,
    redistribute_replica_to_shard,
)
from gsm_data_generator.relax.distributed import DeviceMesh, Placement
...
def const(
    value: Union[bool, int, float, _np.ndarray, gsm_data_generator.nd.NDArray],

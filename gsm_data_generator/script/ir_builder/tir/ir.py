...
from gsm_data_generator.ir import Type
from gsm_data_generator.ir.base import deprecated
from gsm_data_generator.runtime import String, convert, ndarray
from gsm_data_generator.target import Target

# pylint: disable=unused-import
from gsm_data_generator.target.codegen import llvm_lookup_intrinsic_id
from gsm_data_generator.tir import Buffer, BufferRegion, IndexMap, PrimExpr
from gsm_data_generator.tir import op as _tir_op
from gsm_data_generator.tir import type_annotation

# import tir.expr for direct ir construction to pass structural_equal comparison
from gsm_data_generator.tir.expr import (
    EQ,
    GE,
    GT,
    LE,
...
def _as_range(dom: Union[ir.Range, List[PrimExpr]]) -> ir.Range:
    ...
    if isinstance(dom, (list, tuple)):
        from gsm_data_generator.arith import Analyzer  # pylint: disable=import-outside-toplevel

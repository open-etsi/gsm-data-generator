...
from gsm_data_generator import __version__ as tvm_version
from gsm_data_generator import tir
from gsm_data_generator.runtime import Module, load_module, const
from gsm_data_generator.contrib import nvcc
...
class SourceKernel(BaseKernel):  # pylint: disable=too-few-public-methods
    ...
    def compile_to_device_module(  # pylint: disable=arguments-differ
        ...
        """Compile the kernel to a device module."""
        from gsm_data_generator.relax.frontend.nn import SourceModule  # pylint: disable=import-outside-toplevel

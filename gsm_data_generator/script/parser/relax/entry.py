...
from gsm_data_generator.relax.expr import Var
...
class CallableProxy(StructInfoProxy):
    ...
    ret: StructInfoProxy
    purity: bool
    derive_func: Optional[Union[str, gsm_data_generator.ir.EnvFunc]]
    ...
    def __init__(
        ...
        derive_func: Optional[Union[str, gsm_data_generator.ir.EnvFunc]] = None,
    ) -> None:
        if params is None:
            self.params = params
        else:

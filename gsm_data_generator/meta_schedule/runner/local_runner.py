...
def _worker_func(
    ...
    with resource_handler():
        ...
        with Profiler.timeit("LocalRunner/load_module"):
            rt_mod = gsm_data_generator.runtime.load_module(artifact_path)
        # Step 2: Allocate input arguments
        with Profiler.timeit("LocalRunner/alloc_argument"):
            device = gsm_data_generator.runtime.device(dev_type=device_type, dev_id=0)
...
@gsm_data_generator.register_func("meta_schedule.runner.get_local_runner")

...
from gsm_data_generator.ffi import register_object, register_func
from gsm_data_generator.runtime import Object
from gsm_data_generator.target import Target
from gsm_data_generator.tir import PrimFunc, Schedule
...
class TuneContext(Object):
    ...
    def __init__(
        ...
        *,
        ...
        import gsm_data_generator.tir.tensor_intrin  # pylint: disable=unused-import

...
@gsm_data_generator.ffi.register_object("ir.IntSet")
class IntSet(Object):
...
@gsm_data_generator.ffi.register_object("arith.IntervalSet")
...
@gsm_data_generator.ffi.register_object("arith.PresburgerSet")

...
@gsm_data_generator.ffi.register_object("arith.IntGroupBounds")
...
@gsm_data_generator.ffi.register_object("arith.IntConstraints")
...
@gsm_data_generator.ffi.register_object("arith.IntConstraintsTransform")

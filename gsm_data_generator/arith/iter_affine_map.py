...
@gsm_data_generator.ffi.register_object("arith.IterMapExpr")
class IterMapExpr(PrimExpr):
    """Base class of all IterMap expressions."""


@gsm_data_generator.ffi.register_object("arith.IterMark")
...
@gsm_data_generator.ffi.register_object("arith.IterSplitExpr")
...
@gsm_data_generator.ffi.register_object("arith.IterSumExpr")
...
@gsm_data_generator.ffi.register_object("arith.IterMapResult")

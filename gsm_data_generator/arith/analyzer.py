...
from gsm_data_generator.arith import IntSet
...
@gsm_data_generator.ffi.register_object("arith.ModularSet")
...
@gsm_data_generator.ffi.register_object("arith.ConstIntBound")

...
from gsm_data_generator.runtime.container import ShapeTuple
...
@gsm_data_generator.ffi.register_object("relax.ExecBuilder")
class ExecBuilder(Object):
    ...
    def emit_call(
        self,
        name: str,
        args: Optional[List[Union[gsm_data_generator.nd.NDArray, gsm_data_generator.DataType]]] = None,
        dst: int = None,
    ) -> None:
        ...
        if args is not None:
            for arg in args:
                ...
                elif isinstance(arg, (gsm_data_generator.nd.NDArray, gsm_data_generator.DataType, ShapeTuple)):

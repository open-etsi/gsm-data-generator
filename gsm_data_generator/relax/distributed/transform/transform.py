...
def PropagateSharding() -> gsm_data_generator.ir.transform.Pass:
...
def LowerGlobalViewToLocalView() -> gsm_data_generator.ir.transform.Pass:
...
def LegalizeRedistribute() -> gsm_data_generator.ir.transform.Pass:
...
def LowerDistIR() -> gsm_data_generator.ir.transform.Pass:

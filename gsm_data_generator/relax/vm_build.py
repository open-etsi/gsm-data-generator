...
class VMExecutable(Executable):
    ...
    def __init__(self, mod: gsm_data_generator.runtime.Module):
        super().__init__(mod)
...
def _auto_attach_system_lib_prefix(
    tir_mod: gsm_data_generator.IRModule,
    target: Optional[gsm_data_generator.target.Target] = None,
...
def _vmlink(
    builder: "relax.ExecBuilder",
    target: Optional[Union[str, gsm_data_generator.target.Target]],
    tir_mod: Optional[gsm_data_generator.IRModule] = None,
    tir_pipeline: Optional[Union[str, gsm_data_generator.transform.Pass]] = "default",
    ext_libs: List[gsm_data_generator.runtime.Module] = None,
    ...
    *,
    ...
    if tir_mod is not None and len(tir_mod.get_global_vars()) > 0:
        ...
        lib = gsm_data_generator.tir.build(tir_mod, target=target, pipeline=tir_pipeline)
...
def build(
    ...
    params: Optional[Dict[str, list]] = None,
    relax_pipeline: Union[None, str, gsm_data_generator.transform.Pass] = "default",
    tir_pipeline: Union[None, str, gsm_data_generator.transform.Pass] = "default",
    exec_mode: str = "bytecode",
    *,
    system_lib: Optional[bool] = None,
) -> Executable:
    ...
    def _extract_attrs(mod: gsm_data_generator.IRModule):
...
def _filter_tir(mod: gsm_data_generator.IRModule) -> Optional[gsm_data_generator.IRModule]:

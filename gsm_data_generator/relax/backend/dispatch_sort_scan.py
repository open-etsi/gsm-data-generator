    ...
    def visit_call_(self, call: relax.Call) -> relax.Expr:
        ...
        if call.op.name in ("relax.cumprod", "relax.cumsum"):
            ...
            if (
                ...
                from gsm_data_generator.relax.backend.gpu_generic import (  # pylint: disable=import-outside-toplevel

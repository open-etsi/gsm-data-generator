...
from gsm_data_generator.ir import Span, EnvFunc, Array, VDevice
from gsm_data_generator.tir import PrimExpr
from gsm_data_generator.runtime import DataType
from .expr import StructInfo, Expr, ShapeExpr

from . import _ffi_api, ty, expr


@gsm_data_generator.ffi.register_object("relax.ObjectStructInfo")
...
@gsm_data_generator.ffi.register_object("relax.PrimStructInfo")
    ...
    def __init__(
        ...
        if dtype is not None:
            if isinstance(value, PrimExpr):
                ...
                value = gsm_data_generator.tir.const(value, dtype)
...
@gsm_data_generator.ffi.register_object("relax.ShapeStructInfo")
...
@gsm_data_generator.ffi.register_object("relax.TensorStructInfo")
...
@gsm_data_generator.ffi.register_object("relax.TupleStructInfo")
...
@gsm_data_generator.ffi.register_object("relax.FuncStructInfo")
    ...
    def opaque_func(
        *,
        ...
        if isinstance(derive_func, str):
            derive_func = gsm_data_generator.ir.EnvFunc.get("tvm.relax.struct_info.infer_view_sinfo")

...
from gsm_data_generator.relax import ExprFunctor
...
class ASTPrinter(ExprFunctor):
    ...
    def visit_call_(self, op: relax.Call) -> str:
        ...
        if op.attrs and self.include_call_attrs:
            ...
            def display_attrs(attr_key):
                ...
                elif isinstance(attr_val, gsm_data_generator.tir.IntImm):
    ...
    def visit_op_(self, op: gsm_data_generator.ir.Op) -> str:
    ...
    def visit_type_(self, type_node: relax.Type) -> str:
        ...
        if isinstance(type_node, gsm_data_generator.ir.PrimType):

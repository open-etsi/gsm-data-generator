...
from gsm_data_generator import topi, tir, relax, te
from gsm_data_generator.relax.op.base import call_tir
from gsm_data_generator.relax.struct_info import TensorStructInfo
from gsm_data_generator.relax.utils import gen_call_tir_inputs
...
def _layout_transform(bb: BlockBuilder, call: Call) -> Expr:
    ...
    index_map: gsm_data_generator.tir.IndexMap = call.attrs.index_map
    ...
    axis_separators: gsm_data_generator.tir.IndexMap.AXIS_SEPARATOR = call.attrs.axis_separators
    input_axis_separators: gsm_data_generator.tir.IndexMap.AXIS_SEPARATOR = call.attrs.input_axis_separators
    ...
    if not isinstance(padding_predicate, gsm_data_generator.tir.expr.IntImm):

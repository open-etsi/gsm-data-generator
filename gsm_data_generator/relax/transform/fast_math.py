...
from gsm_data_generator.relax import Call, Expr, PyExprMutator, expr_functor
...
@gsm_data_generator.transform.module_pass(opt_level=0, name="FastMathTransform")
class FastMathTransform:
    """
    Pass to convert the expensive non linear functions to their fast but approximate counterparts.
    """

    def transform_module(self, mod: IRModule, ctx: gsm_data_generator.transform.PassContext) -> IRModule:

...
from gsm_data_generator.relax.expr import Expr, Var
from gsm_data_generator.relax.expr_functor import PyExprMutator, PyExprVisitor, mutator, visitor


@gsm_data_generator.transform.module_pass(opt_level=0, name="IPCAllReduceRewrite")
class IPCAllReduceRewrite:
    ...
    def transform_module(self, mod: IRModule, _ctx: gsm_data_generator.transform.PassContext) -> IRModule:
        ...
        fcustom_allreduce = gsm_data_generator.get_global_func(
...
class _Visitor(PyExprVisitor):  # pylint: disable=abstract-method
    def __init__(self, allreduce_strategy: int) -> None:
        ...
        self.reshape_op = gsm_data_generator.ir.Op.get("relax.reshape")

...
from gsm_data_generator.ir import Type, TupleType, FuncType, Span

from . import _ffi_api


@gsm_data_generator.ffi.register_object("relax.ShapeType")
...
@gsm_data_generator.ffi.register_object("relax.ObjectType")
...
@gsm_data_generator.ffi.register_object("relax.DynTensorType")
...
@gsm_data_generator.ffi.register_object("relax.PackedFuncType")

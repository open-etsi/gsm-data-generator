...
from gsm_data_generator.ir.expr import PrimExpr
...
class DFPattern(Node):
    ...
    def has_shape(self, shape: List[PrimExpr]) -> "ShapePattern":
        ...
        """
        if not isinstance(shape, (list, tuple, gsm_data_generator.ir.PrimExpr)):
...
class ShapePattern(DFPattern):
    ...
    def __init__(self, pattern: "DFPattern", shape: List[gsm_data_generator.ir.PrimExpr]):
...
class PrimArrPattern(DFPattern):
    ...
    def __init__(self, shape: List[gsm_data_generator.ir.PrimExpr]):
...
class AttrPattern(DFPattern):
    ...
    def __init__(self, pattern: "DFPattern", attrs: gsm_data_generator.ir.attrs.Attrs):
...
def is_shape(shape: List[gsm_data_generator.ir.PrimExpr]) -> "PrimArrPattern":
    """
    ...
    """
    if not isinstance(shape, (list, tuple, gsm_data_generator.ir.Array)):

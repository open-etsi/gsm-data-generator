...
from gsm_data_generator.relax.ty import Type
from gsm_data_generator.relax.struct_info import StructInfo, FuncStructInfo
from gsm_data_generator.relax.expr import DataflowBlock, Var, GlobalVar, Expr, Function, Call, Binding
from gsm_data_generator.tir import IndexMap, PrimFunc, Block, Buffer
...
def derive_call_ret_struct_info(
    func_sinfo: FuncStructInfo, call: Call, ctx: "gsm_data_generator.relax.BlockBuilder"
) -> StructInfo:
...
def detect_recursion(mod: gsm_data_generator.IRModule) -> List[List[GlobalVar]]:
    """

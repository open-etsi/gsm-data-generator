...
@gsm_data_generator.ffi.register_object("relax.DataflowBlockRewrite")
class DataflowBlockRewrite(Object):
    ...
    def mutate_irmodule(self, irmodule: gsm_data_generator.IRModule) -> gsm_data_generator.IRModule:
        """

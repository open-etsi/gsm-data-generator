...
class ExportedProgramImporter(BaseFXGraphImporter):
    ...
    def create_input_vars(
        ...
        torch_symbol_to_relax_var: Dict[str, gsm_data_generator.tir.Var] = {}
        ...
        for spec in exported_program.graph_signature.input_specs:
            ...
            relax_shape = [
                torch_symbol_to_relax_var.setdefault(str(s), gsm_data_generator.tir.SizeVar(str(s), "int64"))
    ...
    def from_exported_program(
        ...
        for tensor_name, tensor_value in to_bind_parameters.items():
            ...
            for spec in exported_program.graph_signature.input_specs:
                if tensor_name == spec.target:
                    ...
                    break
            binding[bind_name] = gsm_data_generator.nd.from_dlpack(tensor_value.detach())
        ...
        if keep_params_as_input:
            ...
            params = [gsm_data_generator.nd.from_dlpack(p.detach()) for p in parameters.values()]

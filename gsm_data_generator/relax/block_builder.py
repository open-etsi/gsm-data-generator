...
class TestingScope(object):
    ...
    def __init__(self, block_builder, def_vars):
        ...
        shape_vars = []
        for var in def_vars:
            if isinstance(var, gsm_data_generator.tir.Var):
...
@gsm_data_generator.ffi.register_object("relax.BlockBuilder")
class BlockBuilder(Object):
    ...
    def get(self) -> gsm_data_generator.IRModule:
    ...
    def finalize(self) -> gsm_data_generator.IRModule:

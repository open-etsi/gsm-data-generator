...
import gsm_data_generator.ir
import gsm_data_generator.relax
from gsm_data_generator import DataType
from gsm_data_generator.runtime import Object
from gsm_data_generator.runtime import ndarray as _nd
...
Expr = Union[gsm_data_generator.ir.RelaxExpr]
Type = Union[gsm_data_generator.ir.Type]  # pylint: disable=invalid-name
GlobalVar = Union[gsm_data_generator.ir.GlobalVar]


@gsm_data_generator.ffi.register_object("relax.Id")
class Id(Object):
...
@gsm_data_generator.ffi.register_object("ir.StructInfo")
class StructInfo(Node, Scriptable):
    ...
    def __eq__(self, other):
        ...
        return gsm_data_generator.ir.structural_equal(self, other)
...
class ExprWithOp(Expr, Scriptable):
    ...
    def __add__(self, other: Expr) -> "ExprWithOp":
        if isinstance(self.struct_info_, gsm_data_generator.relax.TupleStructInfo) and isinstance(other, tuple):
    ...
    def __getitem__(self, index: int) -> "ExprWithOp":
        ...
        except gsm_data_generator.TVMError as err:
    ...
    def _check_for_tensor_struct_info(self):
        ...
        if not isinstance(self.struct_info_, gsm_data_generator.relax.TensorStructInfo):
            raise TypeError(
    ...
    def ndim(self) -> "Expr":
        ...
        self._check_for_tensor_struct_info()
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_ndim")
        return gsm_data_generator.relax.Call(op, [self])
    ...
    def byte_offset(self) -> "Expr":
        ...
        self._check_for_tensor_struct_info()
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_byte_offset")
        return gsm_data_generator.relax.Call(op, [self])
    ...
    def elem_offset(self) -> "Expr":
        ...
        """
        self._check_for_tensor_struct_info()
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_elem_offset")
        return gsm_data_generator.relax.Call(op, [self])


class _DLTensorDTypeProxy(gsm_data_generator.runtime.ObjectGeneric):
    ...
    def type_code(self) -> Expr:
        ...
        """
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_dtype_code")
        return gsm_data_generator.relax.Call(op, [self.tensor])
    ...
    def lanes(self) -> Expr:
        ...
        """
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_dtype_lanes")
        return gsm_data_generator.relax.Call(op, [self.tensor])
    ...
    def bits(self) -> Expr:
        ...
        """
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_dtype_bits")
        return gsm_data_generator.relax.Call(op, [self.tensor])


class _DLTensorShapeProxy(gsm_data_generator.runtime.ObjectGeneric):
    ...
    def __getitem__(self, axis: Union[int, PrimExpr, Expr]) -> Expr:
        ...
        if not isinstance(axis, gsm_data_generator.relax.Expr):
            axis = gsm_data_generator.relax.PrimValue(axis)

        if axis.struct_info_ is not None and not isinstance(
            axis.struct_info_, gsm_data_generator.relax.PrimStructInfo
        ):
            raise TypeError(
        ...
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_shape_i")
        return gsm_data_generator.relax.Call(op, [self.tensor, axis])


class _DLTensorStrideProxy(gsm_data_generator.runtime.ObjectGeneric):
    ...
    def __getitem__(self, axis: Union[int, PrimExpr, Expr]) -> Expr:
        ...
        op = gsm_data_generator.ir.Op.get("relax.inspect.tensor_stride_i")
        return gsm_data_generator.relax.Call(op, [self.tensor, axis])


@gsm_data_generator.ffi.register_object("relax.expr.Call")
class Call(ExprWithOp):
    ...
    op: Expr
    args: List[Expr]
    attrs: gsm_data_generator.ir.Attrs
    sinfo_args: List[StructInfo]
    span: Optional[Span]

    def __init__(
        self,
        op: Union[Expr, gsm_data_generator.ir.Op],
        args: Union[List[Expr], typing.Tuple[Expr, ...]],
        attrs: Optional[gsm_data_generator.ir.Attrs] = None,
...
@gsm_data_generator.ffi.register_object("relax.expr.If")
class If(ExprWithOp):
...
@gsm_data_generator.ffi.register_object("relax.expr.Tuple")
class Tuple(ExprWithOp):
    ...
    def __init__(
        ...
        if isinstance(fields, gsm_data_generator.relax.Tuple):
            fields = fields.fields
        elif isinstance(getattr(fields, "struct_info_", None), gsm_data_generator.relax.TupleStructInfo):
            fields = [*fields]
...
@gsm_data_generator.ffi.register_object("relax.expr.TupleGetItem")
...
@gsm_data_generator.ffi.register_object("relax.expr.ShapeExpr")
class ShapeExpr(ExprWithOp):
    ...
    def __init__(
        self,
        values: Union[List[PrimExpr], typing.Tuple[PrimExpr, ...], gsm_data_generator.ir.Array],
        span: Optional[Span] = None,
    ) -> None:
...
@gsm_data_generator.ffi.register_object("relax.expr.Constant")
class Constant(ExprWithOp):
    ...
    data: gsm_data_generator.nd.NDArray
    span: Optional[Span]
...
@gsm_data_generator.ffi.register_object("relax.expr.Var")
class Var(ExprWithOp):
    ...
    def __init__(
        ...
        if struct_info is not None:
            struct_info = gsm_data_generator.runtime.convert(struct_info)
...
@gsm_data_generator.ffi.register_object("relax.expr.DataflowVar")
...
@gsm_data_generator.ffi.register_object("relax.expr.PrimValue")
class PrimValue(Expr, Scriptable):
    ...
    def __init__(self, value: Union[PrimExpr, int], span: Optional[Span] = None) -> None:
        if isinstance(value, int):
            value = gsm_data_generator.tir.IntImm("int64", value)
        self.__init_handle_by_constructor__(_ffi_api.PrimValue, value, span)  # type: ignore


@gsm_data_generator.ffi.register_object("relax.expr.StringImm")
...
@gsm_data_generator.ffi.register_object("relax.expr.DataTypeImm")
...
@gsm_data_generator.ffi.register_object("relax.expr.Binding")
...
@gsm_data_generator.ffi.register_object("relax.expr.MatchCast")
...
@gsm_data_generator.ffi.register_object("relax.expr.VarBinding")
...
@gsm_data_generator.ffi.register_object("relax.expr.BindingBlock")
...
@gsm_data_generator.ffi.register_object("relax.expr.DataflowBlock")
...
@gsm_data_generator.ffi.register_object("relax.expr.SeqExpr")
...
@gsm_data_generator.ffi.register_object("relax.expr.Function")
class Function(BaseFunc, Scriptable):
    ...
    is_pure: bool
    attrs: gsm_data_generator.ir.DictAttrs
    span: Optional[Span]
    ...
    def __init__(
        ...
        attrs: Optional[gsm_data_generator.ir.DictAttrs] = None,
        span: Optional[Span] = None,
    ) -> None:
        self.__init_handle_by_constructor__(
            _ffi_api.Function,
    ...
    def bind_symbolic_vars(
        self, binding_map: Mapping[Union[str, gsm_data_generator.tir.Var], PrimExpr]
    ) -> "Function":
        ...
        binding_map = {
            key: gsm_data_generator.tir.const(value, "int64") if isinstance(value, int) else value
    ...
    def bind_params(
        ...
        binding_map: Mapping[
            Union[str, Var],
            Union[int, float, PrimExpr, gsm_data_generator.runtime.NDArray, _np.ndarray, Expr],
        ],
    ) -> "Function":
        """Return a new function with updated symbolic variable
        ...
        def _normalize_value(value):
            ...
            if isinstance(value, int):
                # Relax uses int64 for symbolic variables, but the FFI
                # converts python integers into int32.
                return gsm_data_generator.tir.const(value, "int64")
            elif isinstance(value, (_np.ndarray, gsm_data_generator.nd.NDArray)):
                return gsm_data_generator.relax.const(value)
            else:
                return value
    ...
    def inline_functions(
        self, function_map: Mapping[Union[str, gsm_data_generator.ir.GlobalVar], "Function"]
    ) -> "Function":
        return _ffi_api.FunctionInlineFunctions(self, function_map)  # type: ignore


@gsm_data_generator.ffi.register_object("relax.expr.ExternFunc")
...
def const(
    value: Union[bool, int, float, _np.ndarray, gsm_data_generator.nd.NDArray], dtype: Optional[str] = None
) -> Constant:
...
@gsm_data_generator.ffi.register_object("relax.TEPlaceholderOp")
class TEPlaceholderOp(gsm_data_generator.te.tensor.Operation):
    """The placeholder op that represents a relax expression."""


def te_tensor(
    value: Expr, tir_var_map: Dict[gsm_data_generator.tir.Var, gsm_data_generator.tir.PrimExpr], name: str = "rxplaceholder"
):

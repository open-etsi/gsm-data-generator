...
from gsm_data_generator.contrib.msc.core.ir.graph import MSCGraph
from gsm_data_generator.contrib.msc.core.frontend import from_relax, normalize_inputs
...
) -> Tuple[Union[MSCGraph, gsm_data_generator.IRModule], Dict[str, gsm_data_generator.nd.array]]:

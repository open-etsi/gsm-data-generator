...
from gsm_data_generator.contrib.msc.core.frontend import byoc_partition
from gsm_data_generator.contrib.msc.framework.tensorrt import transform as trt_transform
...
def transform_for_tensorrt(
    ...
    return gsm_data_generator.transform.Sequential(
        [

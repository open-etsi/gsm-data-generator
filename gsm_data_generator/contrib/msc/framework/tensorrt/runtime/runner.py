...
from gsm_data_generator.contrib.msc.core.runtime import BYOCRunner
...
from gsm_data_generator.contrib.msc.framework.tensorrt.frontend import (
    partition_for_tensorrt,
    transform_for_tensorrt,
)
from gsm_data_generator.contrib.msc.framework.tensorrt.codegen import to_tensorrt
from gsm_data_generator.contrib.msc.framework.tensorrt import tools
...
class TensorRTRunner(BYOCRunner):
    ...
    @classmethod
    def target_transform(cls, mod: gsm_data_generator.IRModule):

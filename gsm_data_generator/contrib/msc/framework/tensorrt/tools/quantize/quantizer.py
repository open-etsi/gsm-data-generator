...
from gsm_data_generator.contrib.msc.core.tools.quantize import BaseQuantizer, QuantizeStage
...
class TensorRTQuantizerFactory(object):
    ...
    def create(self, base_cls: BaseQuantizer) -> BaseQuantizer:
        ...
        class Quantizer(base_cls):
            ...
            def _reset(
                self, graphs: List[MSCGraph], weights: List[Dict[str, gsm_data_generator.nd.array]]
            ) -> Tuple[List[MSCGraph], List[Dict[str, gsm_data_generator.nd.array]]]:
                """Reset the tool

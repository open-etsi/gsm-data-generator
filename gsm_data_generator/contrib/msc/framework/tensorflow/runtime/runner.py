...
from gsm_data_generator.contrib.msc.framework.tensorflow.frontend import from_tensorflow
from gsm_data_generator.contrib.msc.framework.tensorflow.codegen import to_tensorflow
from gsm_data_generator.contrib.msc.framework.tensorflow import tf_v1
from gsm_data_generator.contrib.msc.framework.tensorflow import tools
...
class TensorflowRunner(ModelRunner):
    ...
    def _generate_model(
        self, graphs: List[MSCGraph], weights: Dict[str, gsm_data_generator.nd.array]
    ) -> tf_v1.Graph:

...
from gsm_data_generator.contrib.msc.core.runtime import BaseRunner
    ...
    def parse(self) -> Tuple[dict, dict]:
        ...
        if cache_path and os.path.isfile(cache_path):
            with open(cache_path, "r") as f:
                self._relax_mod = gsm_data_generator.ir.load_json(f.read())
            ...
            if cache_path:
                with open(cache_path, "w") as f:
                    f.write(gsm_data_generator.ir.save_json(self._relax_mod))
    ...
    def export_model(self, stage: str, folder: msc_utils.MSCDirectory, dump: bool = True) -> Any:
        ...
        if stage == MSCStage.OPTIMIZE:
            ...
            with open(path, "w") as f:
                f.write(gsm_data_generator.ir.save_json(module))
            return path
...
class MSCPipeWorker(BasePipeWorker):
    ...
    def _get_runner_cls(self, run_type: str) -> BaseRunner:
        ...
        if run_type == MSCFramework.TVM:
            ...
            from gsm_data_generator.contrib.msc.framework.tensorflow.runtime import TensorflowRunner

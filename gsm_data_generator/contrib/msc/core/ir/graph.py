...
@gsm_data_generator.ffi.register_object("msc.core.MSCTensor")
class MSCTensor(Object):
    ...
    def __init__(
        self,
        name: str,
        dtype: Union[str, np.dtype, gsm_data_generator.DataType],
        layout: str,
        shape: List[int],
        alias: Optional[str] = None,
        prims: List[str] = None,
    ):
        if not isinstance(dtype, gsm_data_generator.DataType):
            dtype = gsm_data_generator.DataType(dtype)
...
@gsm_data_generator.ffi.register_object("msc.core.BaseJoint")
class BaseJoint(Object):
    """Base class of all MSC Nodes."""


@gsm_data_generator.ffi.register_object("msc.core.MSCJoint")
...
@gsm_data_generator.ffi.register_object("msc.core.MSCPrim")
...
@gsm_data_generator.ffi.register_object("msc.core.WeightJoint")
...
@gsm_data_generator.ffi.register_object("msc.core.BaseGraph")
class BaseGraph(Object):
    """Base class of all MSC Graphs."""


@gsm_data_generator.ffi.register_object("msc.core.MSCGraph")
...
@gsm_data_generator.ffi.register_object("msc.core.WeightGraph")

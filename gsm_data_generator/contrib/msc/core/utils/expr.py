...
def make_span(kwargs: Dict[str, str], span: relax.Span = None) -> relax.Span:
    ...
    span = span or relax.Span(gsm_data_generator.ir.SourceName(""), 0, 0, 0, 0)
...
def get_span_attrs(mod: gsm_data_generator.IRModule) -> dict:
...
def msc_script(mod: gsm_data_generator.IRModule, script: str = "") -> str:

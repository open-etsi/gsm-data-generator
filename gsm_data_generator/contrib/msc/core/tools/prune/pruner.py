...
from gsm_data_generator.contrib.msc.core.ir import MSCGraph, WeightJoint, MSCTensor
from gsm_data_generator.contrib.msc.core.tools.tool import ToolType, WeightTool, ToolStrategy
            ...
            for node in graph.get_nodes():
                for weight in node.get_weights().values():
                    ...
                    if w_name not in self._plan:
                        ...
                        pruned_weights[w_name] = gsm_data_generator.nd.array(data)
                        w_node.set_attr(
                            "pruned_shape",

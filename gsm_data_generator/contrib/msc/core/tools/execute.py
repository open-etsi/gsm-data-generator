...
@gsm_data_generator.register_func("msc_tool.codegen_tensor")
def codegen_tensor(
...
@gsm_data_generator.register_func("msc_tool.codegen_step")
def codegen_step(
...
@gsm_data_generator.register_func("msc_tool.callback_step")

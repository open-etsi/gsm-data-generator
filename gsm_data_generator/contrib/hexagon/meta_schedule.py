...
from gsm_data_generator.runtime import Module, NDArray
from gsm_data_generator.target import Target
from gsm_data_generator.driver import build as tvm_build
from gsm_data_generator.tir.transform import RemoveWeightLayoutRewriteBlock
from gsm_data_generator.contrib.popen_pool import PopenPoolExecutor
from gsm_data_generator.meta_schedule.utils import cpu_count, derived_object
...
def get_hexagon_local_builder(
    pass_context: gsm_data_generator.transform.PassContext = None,
    max_workers: Optional[int] = None,

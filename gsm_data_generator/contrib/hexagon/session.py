...
from gsm_data_generator import runtime
...
class Session:
    ...
    def load_module(self, module: Union[str, pathlib.Path, gsm_data_generator.runtime.Module]):
        """Load TVM module.
        ...
        if isinstance(module, gsm_data_generator.runtime.Module):

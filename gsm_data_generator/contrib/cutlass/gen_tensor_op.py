...
from gsm_data_generator.tir import IntImm
...
@gsm_data_generator.ffi.register_func("contrib.cutlass.instantiate_template")
def instantiate_template(func_name, annotations, func_args):
    ...
    if "decode_matmul" in func_name:
        ...
        if not isinstance(attrs["M"], gsm_data_generator.tir.IntImm):

...
@gsm_data_generator.ffi.register_func("tvm.mrvl.find_value_in_KV_pair")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.GetNodesJSONString")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.ModifyConstNames")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.WriteJsonFile")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.CompileModel")
def compile_model(
    symbol_name,
    nodes_json_string,
    consts_json_string,
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.CleanUpSim")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.SearchPath")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.JsonToBin")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.RunSim")
...
@gsm_data_generator.ffi.register_func("tvm.mrvl.TempDir")
def get_temp_dir():

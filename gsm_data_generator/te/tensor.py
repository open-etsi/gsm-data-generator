...
from gsm_data_generator.runtime import Object, ObjectGeneric
from gsm_data_generator.tir import expr as _expr, DataProducer
...
@gsm_data_generator.ffi.register_object("te.Tensor")
...
@gsm_data_generator.ffi.register_object("te.Operation")
...
@gsm_data_generator.ffi.register_object("te.PlaceholderOp")
class PlaceholderOp(Operation):
    """Placeholder operation."""


@gsm_data_generator.ffi.register_object("te.BaseComputeOp")
...
@gsm_data_generator.ffi.register_object("te.ComputeOp")
class ComputeOp(BaseComputeOp):
    """Scalar operation."""


@gsm_data_generator.ffi.register_object("te.ScanOp")
...
@gsm_data_generator.ffi.register_object("te.ExternOp")
